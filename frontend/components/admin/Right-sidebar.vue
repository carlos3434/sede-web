  ...
  <div>
    ...
    <div v-click-outside="config" class="right-bar">
      <div data-simplebar class="h-100">
        ...
        <div class="p-4">
          <div class="mb-2">
            <router-link tag="a" target="_blank" to="//minible-h-light.nuxt-vuejs.themesbrand.com/">
              <img src="~/assets/images/layouts/layout-4.png" class="img-fluid img-thumbnail" alt />
            </router-link>
          </div>
          <div class="mb-2">
            <router-link tag="a" target="_blank" to="//minible-h-dark.nuxt-vuejs.themesbrand.com/">
              <img src="~/assets/images/layouts/layout-5.png" class="img-fluid img-thumbnail" alt />
            </router-link>
          </div>

          <div class="mb-2">
            <router-link tag="a" target="_blank" to="//minible-h-rtl.nuxt-vuejs.themesbrand.com/">
