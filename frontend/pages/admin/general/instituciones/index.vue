...
export default {
  ...
  data() {
    let pageTitle = 'Lista de Instituciones'

    return {
      title: pageTitle,
      items: [{ text: 'Admin' }, { text: 'Mantenimiento' }, { text: pageTitle, active: true }],
      urlTableData: '/instituciones',
...
<template>
  <div>
    ...
    <GeneralInstitucionAddModal></GeneralInstitucionAddModal>
    <GeneralInstitucionEditModal></GeneralInstitucionEditModal>
    <GeneralInstitucionDeleteModal></GeneralInstitucionDeleteModal>

    <div class="row mx-4">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de instituciones</h2>
            <div class="card-options" v-permission="'INSTITUCION_CREATE'">
              ...
              >
                ...
                <template v-slot:cell(opciones)="data">
                  <ul class="list-inline two-options mb-0">
                    <li class="list-inline-item" v-permission="'INSTITUCION_DESTROY'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'INSTITUCION_EDIT'">
                      <a
                        href="javascript:void(0);"
