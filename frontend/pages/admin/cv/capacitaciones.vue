...
export default {
  ...
  data() {
    return {
      ...
      items: [{ text: 'Admin' }, { text: 'Curriculum Vitae' }, { text: 'Capacitaciones', active: true }],
      urlTableData: '/capacitaciones',
  ...
  methods: {
    ...
    filtersTable(ctx) {
      ...
      filters += ctx.filter ? `&nombre=${ctx.filter}` : ''
...
<template>
  <div>
    ...
    <CvCapacitacionAddModal></CvCapacitacionAddModal>
    <CvCapacitacionEditModal></CvCapacitacionEditModal>
    <CvCapacitacionDeleteModal></CvCapacitacionDeleteModal>

    <div class="row mx-lg-4">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de capacitaciones</h2>
            <div class="card-options" v-permission:all="'CAPACITACION_CREATE'" v-show="!userEstaPostulando">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              <b-table
                ...
                striped
              >
                <template #cell(certificado)="data">
                ...
                <template v-slot:cell(opciones)="data" v-if="!userEstaPostulando">
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item" v-permission="'CAPACITACION_EDIT'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'CAPACITACION_DESTROY'">
                      <a
                        href="javascript:void(0);"
