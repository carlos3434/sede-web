...
export default {
  ...
  data() {
    return {
      ...
      items: [{ text: 'Admin' }, { text: 'Curriculum Vitae' }, { text: 'Verificaciones Realizadas', active: true }],
      urlTableData: '/verificaciones-realizadas',
  ...
  computed: {
    ...
    fileUrl() {
      return process.env.filebaseurl
    }
  },
  created() {
...
<template>
  <div>
    ...
    <AdhocCvVerificacionAddModal></AdhocCvVerificacionAddModal>
    <AdhocCvVerificacionEditModal></AdhocCvVerificacionEditModal>
    <AdhocCvVerificacionDeleteModal></AdhocCvVerificacionDeleteModal>

    <div class="row mx-lg-4">
      <AdhocCvAlertPostulando :seccion="`verificaciones realizadas`"></AdhocCvAlertPostulando>

      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Lista de verificaciones realizadas</h2>
            <div class="card-options" v-permission="'VERIFICACION_REALIZADA_CREATE'" v-show="!userEstaPostulando">
              ...
              >
                ...
                <template v-slot:cell(opciones)="data" v-if="!userEstaPostulando">
                  <ul class="list-inline two-options mb-0">
                    <li class="list-inline-item" v-permission="'VERIFICACION_REALIZADA_EDIT'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'VERIFICACION_REALIZADA_DESTROY'">
                      <a
                        href="javascript:void(0);"
