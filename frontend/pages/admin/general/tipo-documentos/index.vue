...
<template>
  <div>
    ...
    <GeneralTipoDocumentoAddModal></GeneralTipoDocumentoAddModal>
    <GeneralTipoDocumentoEditModal></GeneralTipoDocumentoEditModal>
    <GeneralTipoDocumentoDeleteModal></GeneralTipoDocumentoDeleteModal>

    <div class="row mx-4">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de tipo de documentos</h2>
            <div class="card-options" v-permission="'TIPO_DOCUMENTO_CREATE'">
              ...
              >
                ...
                <template v-slot:cell(opciones)="data">
                  <ul class="list-inline two-options mb-0">
                    <li class="list-inline-item" v-permission="'TIPO_DOCUMENTO_DESTROY'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'TIPO_DOCUMENTO_EDIT'">
                      <a
                        href="javascript:void(0);"
