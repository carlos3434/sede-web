...
export default {
  ...
  data() {
    return {
      ...
      items: [{ text: 'Admin' }, { text: 'Curriculum Vitae' }, { text: 'Formación Académica', active: true }],
      urlTableData: '/formaciones',
...
<template>
  <div>
    ...
    <AdhocCvFormacionAddModal></AdhocCvFormacionAddModal>
    <AdhocCvFormacionEditModal></AdhocCvFormacionEditModal>
    <AdhocCvFormacionDeleteModal></AdhocCvFormacionDeleteModal>

    <div class="row mx-lg-4">
      <AdhocCvAlertPostulando :seccion="`títulos y grados`"></AdhocCvAlertPostulando>

      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de títulos y grados</h2>
            <div class="card-options" v-permission="'FORMACION_CREATE'" v-show="!userEstaPostulando">
