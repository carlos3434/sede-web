...
<template>
  <div>
    ...
    <CvVerificacionAddModal></CvVerificacionAddModal>
    <CvVerificacionEditModal></CvVerificacionEditModal>
    <CvVerificacionDeleteModal></CvVerificacionDeleteModal>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-options" v-permission:all="'VERIFICACION_REALIZADA_CREATE'" v-show="!userEstaPostulando">
