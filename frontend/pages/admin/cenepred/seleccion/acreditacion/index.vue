...
export default {
  ...
  data() {
    return {
      ...
      items: [{ text: 'Admin' }, { text: 'Selección verificadores AdHoc' }, { text: 'Acreditaciones', active: true }],
      ...
      fields: [
        ...
        {
          label: 'F. Inicio Acreditación',
          key: 'acreditacion_fecha_inicio',
          sortable: true,
          visible: true,
          class: 'bs-nro-documento-col text-center'
        },
        {
          label: 'F. Fin Acreditación',
          key: 'acreditacion_fecha_fin',
          sortable: true,
          visible: true,
          class: 'bs-date-col'
        },
  ...
  methods: {
    ...
    getItems(ctx) {
      ...
      let url = `/calificacion/${this.convocatoriaSelected.id}/acreditaciones`
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              ...
              >
                ...
                <template #cell(acreditacion_fecha_inicio)="data">
                  {{ $moment(String(data.value)).format('YYYY-MM-DD') }}
                </template>
                <template #cell(acreditacion_fecha_fin)="data">
                  {{ $moment(String(data.value)).format('YYYY-MM-DD') }}
                </template>
              </b-table>
            </div>
