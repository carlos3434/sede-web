...
export default {
  ...
  data() {
    let pageTitle = 'Tipo de Capacitaciones'

    return {
      title: pageTitle,
      items: [{ text: 'Admin' }, { text: 'Mantenimiento' }, { text: pageTitle, active: true }],
      urlTableData: '/tipocapacitacion',
...
<template>
  <div>
    ...
    <GeneralTipoCapacitacionAddModal></GeneralTipoCapacitacionAddModal>
    <GeneralTipoCapacitacionEditModal></GeneralTipoCapacitacionEditModal>
    <GeneralTipoCapacitacionDeleteModal></GeneralTipoCapacitacionDeleteModal>

    <div class="row mx-4">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de tipo de capacitaciones</h2>
            <div class="card-options" v-permission="'TIPO_CAPACITACION_CREATE'">
              ...
              >
                ...
                <template v-slot:cell(opciones)="data">
                  <ul class="list-inline two-options mb-0">
                    <li class="list-inline-item" v-permission="'TIPO_CAPACITACION_DESTROY'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'TIPO_CAPACITACION_EDIT'">
                      <a
                        href="javascript:void(0);"
