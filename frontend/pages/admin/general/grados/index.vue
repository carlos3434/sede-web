...
<template>
  <div>
    ...
    <GeneralGradoAddModal></GeneralGradoAddModal>
    <GeneralGradoEditModal></GeneralGradoEditModal>
    <GeneralGradoDeleteModal></GeneralGradoDeleteModal>

    <div class="row mx-4">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de grados</h2>
            <div class="card-options" v-permission="'GRADO_CREATE'">
              ...
              >
                ...
                <template v-slot:cell(opciones)="data">
                  <ul class="list-inline two-options mb-0">
                    <li class="list-inline-item" v-permission="'GRADO_DESTROY'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'GRADO_EDIT'">
                      <a
                        href="javascript:void(0);"
