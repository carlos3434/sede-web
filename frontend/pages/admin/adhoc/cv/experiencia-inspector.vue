...
<template>
  <div>
    ...
    <AdhocCvInspectorAddModal></AdhocCvInspectorAddModal>
    <AdhocCvInspectorEditModal></AdhocCvInspectorEditModal>
    <AdhocCvInspectorDeleteModal></AdhocCvInspectorDeleteModal>

    <div class="row mx-lg-4">
      <AdhocCvAlertPostulando :seccion="` su experiencia como inspector`"></AdhocCvAlertPostulando>

      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de experiencias como inspector</h2>
            <div class="card-options" v-permission="'EXPERIENCIA_INSPECTOR_CREATE'" v-show="!userEstaPostulando">
