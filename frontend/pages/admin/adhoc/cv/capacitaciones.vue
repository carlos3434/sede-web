...
<template>
  <div>
    ...
    <AdhocCvCapacitacionAddModal></AdhocCvCapacitacionAddModal>
    <AdhocCvCapacitacionEditModal></AdhocCvCapacitacionEditModal>
    <AdhocCvCapacitacionDeleteModal></AdhocCvCapacitacionDeleteModal>

    <div class="row mx-lg-4">
      <AdhocCvAlertPostulando :seccion="`capacitaciones`"></AdhocCvAlertPostulando>

      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de capacitaciones</h2>
            <div class="card-options" v-permission="'CAPACITACION_CREATE'" v-show="!userEstaPostulando">
