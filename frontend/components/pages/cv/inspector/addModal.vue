    ...
    <b-modal :id="modalId" :title="title" @ok="handleOk" size="lg" @hidden="resetModal">
      <ValidationObserver ref="form" v-slot="{ handleSubmit }" @submit.prevent>
        <b-form @submit.prevent="handleSubmit(onSubmit)">
          ...
          <div class="row">
            <div class="col-6">
              <ValidationProvider mode="eager" rules="required" name="Fecha Inicio" v-slot="{ valid, errors }">
            ...
            <div class="col-6">
              <ValidationProvider mode="eager" rules="required" name="Fecha Fin" v-slot="{ valid, errors }">
