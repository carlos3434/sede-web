...
export default {
  ...
  data() {
    return {
      ...
      msgSuccess: 'Formación Académica eliminada exitosamente!!!',
      isProcessing: false,
      item: {
        id: null,
        text: ''
...
<template>
  <div>
    <b-modal :id="modalId" :title="title" @ok="handleOk" @hidden="hideModal">
      <p>¿Está seguro que desea eliminar esta formación?</p>
      <p>
        <b>{{ item.text }}</b>
      </p>
