...
export default {
  ...
  data() {
    return {
      ...
      items: [{ text: 'Admin' }, { text: 'Mantenimiento' }, { text: 'Configuraciones', active: true }],
      isBusy: false,
  ...
  methods: {
    ...
    getItems(ctx) {
      ...
      let promise = this.$axios.get('/configuraciones' + filters)
...
<template>
  <div>
    ...
    <ConfigAddModal></ConfigAddModal>
    <ConfigEditModal></ConfigEditModal>
    <ConfigDeleteModal></ConfigDeleteModal>

    <div class="row mx-4">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de configuraciones</h2>
            <div class="card-options" v-permission="'CONFIGURACION_CREATE'">
              ...
              >
                <template v-slot:cell(opciones)="data">
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item" v-permission="'CONFIGURACION_DESTROY'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'CONFIGURACION_EDIT'">
                      <a
                        href="javascript:void(0);"
