...
<template>
  <div>
    ...
    <CvProfesionalAddModal></CvProfesionalAddModal>
    <CvProfesionalEditModal></CvProfesionalEditModal>
    <CvProfesionalDeleteModal></CvProfesionalDeleteModal>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-options" v-permission:all="'EXPERIENCIA_CREATE'" v-show="!userEstaPostulando">
