...
export default {
  ...
  data() {
    let pagetitle = 'Solicitar Nº de Hoja de Trámite'
  ...
  methods: {
    requestSolicitar(item) {
      this.$nuxt.$emit('open-solicitar-hoja-tramite-modal', item)
    },
    refreshTable() {
...
<template>
  <div>
    ...
    <AdministradoSolicitarHojaTramiteModal></AdministradoSolicitarHojaTramiteModal>

    <b-modal id="modal-alert" title="Aviso!!!" @ok="handleAlertOk">
      <b-alert variant="warning" show>
        <p>
          Antes de <b>solicitar el número de hoja de trámite</b>, asegurese de elegir correctamente el nombre comercial
          del expediente, adjuntar el anexo nº 5 y el recibo de pago por derecho de revisión del verificador AdHoc.
          <b>Mesa de partes</b> le enviará el nº de hoja de trámite a su correo electronico personal indicado en este
          formulario.
          <b class="text-danger"
            >El límite de tamaño para el anexo nº 5 y para el recibo de pago es 2MB (2 megabytes).</b
          >
        </p>
      </b-alert>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="alert alert-warning m-0" v-if="totalRows == 0">
              <i class="fas fa-exclamation-triangle"></i> Debe ingresar un <b><u> nuevo expediente</u></b> antes de
              solicitar el número de hoja de trámite.
            </div>
            <div class="alert alert-warning m-0" v-if="totalRows > 0">
              Sírvase a <b><u>solicitar el nº de hoja de trámite</u></b> haciendo click en el boton <b>Solicitar</b> (
              <b><i class="fas fa-paper-plane"></i></b> )
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              ...
              >
                ...
                <template #cell(recibo_pago)="data">
                  <template v-if="data.value">
                ...
                <template v-slot:cell(opciones)="data">
                  <template v-if="!data.item.fecha_solicitud_ht">
                    <button
                      type="button"
