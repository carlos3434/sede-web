...
export default {
  ...
  data() {
    return {
      ...
      msgSuccess: 'Formación creada exitosamente!!!',
      item: {
        id: null,
        especialidad: '',
        fecha_expedicion: '',
    ...
    <b-modal :id="modalId" :title="title" @ok="handleOk" size="lg" @hidden="resetModal">
      <ValidationObserver ref="form" v-slot="{ handleSubmit }" @submit.prevent>
        <b-form @submit.prevent="handleSubmit(onSubmit)">
          <ValidationProvider mode="eager" rules="required" name="Especialidad" v-slot="{ valid, errors }">
          ...
          <div class="row">
            <div class="col-6">
              <ValidationProvider mode="eager" rules="required" name="Ciudad" v-slot="{ valid, errors }">
