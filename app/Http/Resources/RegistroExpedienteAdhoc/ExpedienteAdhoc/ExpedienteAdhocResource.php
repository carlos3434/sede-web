...
class ExpedienteAdhocResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'usuario_full_name'        => $this->usuario->full_name,
            'estado_expediente_id'     => $this->estado_expediente_id,
            'estado_expediente_nombre' => $this->estadoExpedienteAdhoc->nombre,
            'usuario_revisor_id'       => $this->usuario_revisor_id,
            'usuario_revisor_full_name'=> (isset($this->usuarioRevisor))?
                                          $this->usuarioRevisor->full_name:null,
