...
export default {
  ...
  data() {
    return {
      title: 'Experiencia como inspector',
      items: [{ text: 'Admin' }, { text: 'Curriculum Vitae' }, { text: 'Experiencia como inspector', active: true }],
      urlTableData: '/experiencias-inspectores',
  ...
  methods: {
    ...
    filtersTable(ctx) {
      ...
      // filters += ctx.filter ? `&institucion_id=${ctx.filter}` : ''
...
<template>
  <div>
    ...
    <CvInspectorAddModal></CvInspectorAddModal>
    <CvInspectorEditModal></CvInspectorEditModal>
    <CvInspectorDeleteModal></CvInspectorDeleteModal>

    <div class="row mx-lg-4">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title">Listado de experiencias como inspector</h2>
            <div class="card-options" v-permission:all="'EXPERIENCIA_INSPECTOR_CREATE'" v-show="!userEstaPostulando">
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template #cell(archivo_constancia)="data">
                  <a :href="$config.filebaseurl + data.value" target="_blank" class="text-decoration">
                ...
                <template v-slot:cell(opciones)="data" v-if="!userEstaPostulando">
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item" v-permission="'EXPERIENCIA_INSPECTOR_EDIT'">
                      <a
                    ...
                    <li class="list-inline-item" v-permission="'EXPERIENCIA_INSPECTOR_DESTROY'">
                      <a
                        href="javascript:void(0);"
